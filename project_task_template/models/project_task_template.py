...
class ProjectTaskTemplate(models.Model):
    ...
    project_template_id = fields.Many2one(string="Project Template", comodel_name="project.template", required=True, )
    ...
    sequence = fields.Integer(string="Sequence", required=True, default=True, )
